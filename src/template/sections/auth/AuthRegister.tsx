...
import { confirmPasswordSchema, emailSchema, firstNameSchema, lastNameSchema, passwordSchema } from 'template/utils/validationSchema';

// assets
import DarkLogo from 'template/assets/images/logo-dark.svg';
