...
import SimpleBarScroll from 'template/components/third-party/SimpleBar';
import { handlerDrawerOpen, useGetMenuMaster } from 'template/api/menu';

// assets
import Img1 from 'template/assets/images/user/avatar-1.png';
import Img2 from 'template/assets/images/user/avatar-2.png';
import Img3 from 'template/assets/images/user/avatar-3.png';
import Img4 from 'template/assets/images/user/avatar-4.png';
import Img5 from 'template/assets/images/user/avatar-5.png';
